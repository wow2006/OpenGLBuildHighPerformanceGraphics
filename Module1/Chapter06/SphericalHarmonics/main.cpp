...
const std::string mesh_filename = "SphericalHarmonicsData/media/blocks.obj";
...
void OnInit() {
  ...
  flatShader.LoadFromFile(GL_VERTEX_SHADER, "SphericalHarmonicsData/shaders/flat.vert");
  flatShader.LoadFromFile(GL_FRAGMENT_SHADER, "SphericalHarmonicsData/shaders/flat.frag");
  ...
  sh_shader.LoadFromFile(GL_VERTEX_SHADER, "SphericalHarmonicsData/shaders/sh_shader.vert");
  sh_shader.LoadFromFile(GL_FRAGMENT_SHADER, "SphericalHarmonicsData/shaders/sh_shader.frag");
  // compile and link shader
  ...
  shader.LoadFromFile(GL_VERTEX_SHADER, "SphericalHarmonicsData/shaders/shader.vert");
  shader.LoadFromFile(GL_FRAGMENT_SHADER, "SphericalHarmonicsData/shaders/sh_shader.frag");
